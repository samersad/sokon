...
class _UserLocationPickerState extends State<UserLocationPicker> {
  ...
  void initState() {
    ...
    _selectedLocation = locationViewModel.userLocation;
    _selectedAddress = locationViewModel.userAddress;
  }
  ...
  Future<void> _confirmSelection() async {
    ...
    await context.read<LocationViewModel>().changeUserLocation(
      selectedLocation,
      ...
      body: BlocBuilder<LocationViewModel, LocationState>(
        builder: (context, state) {
          final initialTarget = _selectedLocation ??
              locationViewModel.userLocation ??
