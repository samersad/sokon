              ...
              Expanded(
                child: user == null
                    ...
                    : StreamBuilder<QuerySnapshot<Booking>>(
                        stream: FireBaseUtils.getBookingsStream(user.id, user.role == 'owner'),
                        builder: (context, snapshot) {
                          ...
                          var bookings = snapshot.data!.docs.map((doc) => doc.data()).toList();
          ...
          Row(
            children: [
              ClipRRect(
                ...
                child: (booking.apartmentImage != null && booking.apartmentImage!.isNotEmpty)
                    ? Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) =>
                            Image.asset(AppAssets.image, width: 70.w, height: 70.h),
                      )
                    : Image.asset(AppAssets.image, width: 70.w, height: 70.h),
              ),
              SizedBox(width: 15.w),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.location_on, color: AppColors.grayColor, size: 14.sp),
                        SizedBox(width: 4.w),
                        Expanded(
                          child: Text(
